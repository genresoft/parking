    ...
    <div class="sidebar-content" style="background-color: #0093D0">
        <div class="nav-container" style="background-color: #0055A5; color: white;">
            <nav id="main-menu-navigation" class="navigation-main">
                <div class="nav-lavel" style="background-color: rgba(252, 176, 52, 1); color: white;">Navigation</div>
                ...
                <div class="nav-lavel" style="background-color: rgba(252, 176, 52, 1); color: white;">UI Element</div>
                ...
                <div class="nav-lavel" style="background-color: rgba(252, 176, 52, 1); color: white;">Reports Section</div>
                <div class="nav-item active">
